    ...
    return (
        <div className="w-screen h-screen flex flex-col">
            ...
            <div className="w-full h-full flex items-center justify-center flex-col p-4">
                ...
                <form onSubmit={handleForm} method="POST" action={url+"/game" + pin} className="max-w-[320px] max-h-[400px] bg-gray-800 rounded-lg flex items-center justify-center flex-col p-4">
